              ...
              >
                <div className="flex items-center gap-4">
                  {project.photo_url ? (
                    ...
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-xl border border-[#701a2e]/15 bg-gradient-to-br from-[#701a2e]/10 to-[#701a2e]/5 text-[#701a2e] shadow-2xs">
