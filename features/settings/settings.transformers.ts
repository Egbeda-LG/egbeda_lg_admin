...
export function toOrganizationSettings(
  ...
  return {
    organization: {
      ...
      no_of_pry_schools: numberValue(values.numberOfPrimarySchools),
      no_of_sec_schools: numberValue(values.numberOfSecondarySchools),
...
export function fromOrganizationSettings(
  ...
  return {
    ...
    numberOfPrimarySchools: str(org.no_of_pry_schools),
    numberOfSecondarySchools: str(org.no_of_sec_schools),
