...
export const organizationSettingsFormSchema = z.object({
  ...
  numberOfPrimarySchools: numeric("Number of primary schools"),
  numberOfSecondarySchools: numeric("Number of secondary schools"),
...
export const ORGANIZATION_FIELDS: SettingsField[] = [
  ...
  { name: "numberOfPrimarySchools", label: "NUMBER OF PRIMARY SCHOOLS" },
  { name: "numberOfSecondarySchools", label: "NUMBER OF SECONDARY SCHOOLS" },
